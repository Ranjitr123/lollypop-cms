...
<h1 class="fnt-78 fnt-800 mb-3 mb-md-4 red-stroke red-stroke--small13 px-md-0">
...
<?php while(have_rows('we_covered_repeater')){the_row();?>
<div class="row">
...
<?php while(have_rows('behaviour_repeater')){the_row();?>
...
<ul class="li-disc ms-2 ms-lg-0">
<?php while(have_rows('pain_repeater')){the_row();?>
...
<ul class="li-disc ms-2 ms-lg-0">
<?php while(have_rows('takeaways_repeater')){the_row();?>
...
<div class="project-step-disc__item">
<ul class="li-disc ms-2"> 
<?php while(have_rows('conclusion_repeater')){the_row();?>
...
<div class="project-step-disc__item">
<ul class="li-disc ms-2"> 
<?php while(have_rows('points_repeater')){the_row();?>
        ...
        <div class="col-12 col-md-11 col-lg-10 mx-auto">
          <div class="row mb-60">
            ...
            <ul class="px-0 ft-social-links d-flex flex-wrap justify-content-center">
              ...
              <li class="ft-social-links__item col-6 col-sm-3 col-md-3 mb-3 mb-sm-0 text-center"> <a class="fnt-30 fnt-800 link-insta" href="https://www.instagram.com/lollypop.design/" targ
et="_blank">Instagram</a></li>
