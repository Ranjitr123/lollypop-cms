        ...
        <div class="col-12 col-md-11 col-lg-11 mx-auto">
          <div class="row">
            <div class="col-12 col-md-11 offset-md-1">
              <div class="mb-r-80 col-md-12 col-lg-11 px-0 mx-auto"> <span class="d-block fnt-28 fnt-800 text-capitalize mb-2 clr-default locations" style="color: #FD2E35;"><?php the_field('locations'); ?></span>
                        ...
                        <div class="srv__info col-12 col-md-8">
                          <div class="row justify-content-between">
                            <div class="col-12 col-md-6">
                              ...
                              <a class="hvr-line clr-second fnt-14 data-scroll tab-sw-hd d-none d-md-inline-block" tab-id="#<?php the_sub_field('title'); ?>" href="<?php the_sub_field('learn_more_url'); ?>"><?php the_sub_field('learn_more_text'); ?></a>
                            </div>
                            <div class="col-12 col-md-5">
                              ...
                              <a class="hvr-line clr-second fnt-14 data-scroll tab-sw-hd d-md-none" tab-id="#<?php the_sub_field('title'); ?>" href="<?php the_sub_field('learn_more_url'); ?>"><?php the_sub_field('learn_more_text'); ?></a>
                            </div>
                          </div>
                        </div>
            ...
            <div class="d-flex align-items-center justify-content-center">
              <div class="col-12 col-md-8 col-lg-7 px-0 d-inline-block clr-white text-center">
                <?php if (have_rows('get_in_touch')) : while (have_rows('get_in_touch')) : the_row(); ?>
                    ...
                    <a class="web-btn web-btn--red" href="<?php the_sub_field('cta_url'); ?>"><?php the_sub_field('cta_text'); ?></a>
                <?php wp_reset_postdata();
                  endwhile;
                endif; ?>
              </div>
