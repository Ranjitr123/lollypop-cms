<?php
/**
 * * * Template Name: Dubai Event Upload
 * * */
...
$mail->Subject = "STEP DUBAI 2023 Query" ;
$content .=
...
echo "False";
	...
	$mailReply->Subject = "Thanks for taking the first STEP!";
	$contentReply .=
	...
	="width:100%;font-size:32px;padding: 8px 0;font-weight:bold;letter-spacing:-1.2px;line-height:38px;color:#333333;">Thanks for taking the first STEP! </td></tr><tr><td align="left" style="width:10
	0%;padding: 8px 0;font-size:16px;font-weight:400;line-height:24px;color:#333333;font-family:Helvetica, sans-serif"> Hello ' .
	$_POST['full_name'] . 
	'!<br> <br>Hope you had a great time at #STEP2023.</td></tr><tr><td align="left" style="width:100%;font-size:16px;padding: 8px 0;font-weight:400;line-height:24px;color:#333333;"> 
