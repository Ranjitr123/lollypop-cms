              ...
              <div class="row">
                <div class="col-12 col-md-8 offset-md-1 mb-4 mb-md-5 pb-lg-5">
                  <div class="sec-content data-scroll">
                    <h2>About Us</h2>
                    <p>The domain name <a href="https://lollypop.design">https://lollypop.design</a>(hereinafter referred to as "Website") owned and managed by Pixitree Digital Creatives Private Limited, a private limited company limited by shares incorporated in India under the Companies Act, 2013, and having its registered office at 1663, 27th Main Road, Sector 2, HSR Layout, Bangalore, Karnataka, India – 560102 (hereinafter referred to as “Company”).</p>
                    <p>
                       The Company is an out and out creative user interface and user experience studio based in Bangalore, India. The Company basically designs across all platforms from websites and online tools to mobile apps, software, and basically just about anything that demands user interface.</p>
                  </div>
                  <div class="sec-content data-scroll">
                    <h2>Terms of Use</h2>
                  ...
                  <div class="sec-content data-scroll">
                    <h2>Privacy and Information Protection</h2>
                     <p>ACCESSING, BROWSING OR OTHERWISE USING THE WEBSITE INDICATES YOUR ACCEPTANCE TO ALL THE TERMS AND CONDITIONS HEREIN. PLEASE READ THESE TERMS OF USE CAREFULLY BEFORE PROCEEDING. IF YOU DO NOT AGREE WITH THE SAME, PLEASE DO NOT USE THIS WEBSITE.</p>
                    <p>Please review our Privacy Policy, which also governs your visit to this Site, to understand our internal policies and practices. The personal information/data provided to us by you during the course of usage of http://lollypop.design/ will be treated as strictly confidential and in accordance with the Privacy Policy and applicable laws and regulations. If You object to your information being transferred or used, please do not use the website.</p>
                  </div>
                  <div class="sec-content data-scroll">
                    <h2>Charges for using the Website</h2>
              ...
              <div class="row">
                <div class="col-12 col-md-8 offset-md-1">
                  ...
                  <div class="sec-content data-scroll">
                    ...
                    <p>
                      This site is owned and operated by Pixitree Digital Creatives Private Limited. If You have any have any question, issue, complaint regarding any of our Services, please contact
                      &nbsp;<a href="mailto:info@lollypop.design">info@lollypop.design.</a>
                    </p>
                  </div>
                </div>
              </div>
