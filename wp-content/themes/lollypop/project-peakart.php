...
<section class="section-style">
    <div class="container">
        <?php if (have_rows('content_middle_section')): ?>
            <?php while (have_rows('content_middle_section')): the_row(); ?>
                
                <!-- Section Heading -->
                <?php if (get_sub_field('section_heading') != ''): ?>
                    <div class="w-100 section-heading" style="color: black; font-size: 54px; text-align: left; font-weight: 700; font-family: 'Phudu', sans-serif;">
                ...
                <?php if (get_sub_field('section_image') != ''): ?>
                    <div class="w-100 section-img">
                        <img class="img-project-dtl data-scroll" src="<?php the_sub_field('section_image'); ?>" alt="Image">
                    </div>
                <?php endif; ?>
                        ...
                        <div class="col-12 col-md-11 col-lg-10 mx-auto">
                            <div class="col-md-10 px-0 mx-auto">
                                <div class="project-step">
                                    <div class="brief-item row">
                                        <div class="col-12 col-md-4 mb-3 mb-md-0">
                                            <span class="red-stroke clr-second fnt-24 text-start d-inline-block fnt-700 data-scroll disc-head text-rpd text-rpd--more">
                ...
                <?php elseif (get_sub_field('section_content') != ''): ?>
