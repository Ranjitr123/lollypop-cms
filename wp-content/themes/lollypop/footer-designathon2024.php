...
<style>
	...
	.athon-footer .footer-logo-links__item a {
		color: #fff !important;
	}
...
<footer class="footer pt-5" style="background: #02323E ;">
	<div class="container">

		<div class="row" >
			<div class="col-12 col-md-11 col-lg-11 mx-auto">
				<div class="row mb-60">
					<!-- <h5 class="fnt-16 fnt-600 mb-22 text-center white">Catch us candid here</h5> -->
					<ul class="px-0 ft-social-links d-flex flex-wrap justify-content-center">
						<!-- <li class="ft-social-links__item col-4 col-sm-2 col-md-2 mb-3 mb-sm-0 text-center"><a class="fnt-30 fnt-800 link-linkedin" href="https://www.linkedin.com/company/lollypop-vietnam" target="_blank">LinkedIn</a></li> -->
						...
						<!-- <li class="ft-social-links__item col-4 col-sm-2 col-md-2 mb-3 mb-sm-0 text-center"> <a class="fnt-30 fnt-800 link-fb" href="https://www.facebook.com/lollypopvietnam" target="_blank">Facebook</a></li> -->
				...
				<div class="row">
					<div class="col-12 col-md-4 mb-4 mb-md-0 order-2 order-md-1 text-center text-md-left"><a class="clr-second d-inline-block fnt-24 lp-link--red fnt-800 mb-4 mb-md-2 col-8 col-lg-6 px-0" href="<?php echo site_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/designathon23/lollypop-logo.svg" style="width:100%" alt="Image"></a>
						<p class="fnt-14 fnt-300 clr-white mb-0 pb-1 mb-md-3 mb-lg-4 pb-lg-0 px-0 mt-2">A&nbsp;<a href="https://www.terralogic.com/" class="fnt-800 hvr-link fnt-16 d-inline-block clr-white">Terralogic</a>&nbsp;company crafting meaningful experiences through Research, Design and Development.</p>
						<ul class="mt-5 mt-md-0 footer-logo-links fnt-400 fnt-14 d-flex justify-content-center justify-content-md-start flex-wrap px-0 mb-0">
							<li class="footer-logo-links__item col-12 px-0 ">
								<div class="fnt-12 white">© 2024 Lollypop - A Terralogic company</div>
							</li>
							<li class="footer-logo-links__item"> <a class="fnt-12 white" href="<?php echo site_url(); ?>/frequently-ask-questions/">FAQs</a></li>
							<li class="footer-logo-links__item"> <a class="fnt-12 white" href="<?php echo site_url(); ?>/privacy-policy/">Privacy Policy</a></li>
							<li class="footer-logo-links__item"> <a class="fnt-12 white" href="<?php echo site_url(); ?>/terms-of-use/">Terms of Use</a></li>
						</ul>
					</div>
					<div class="col-12 col-md-7 col-lg-8 order-1 order-md-2 mb-5 mb-md-0">
						<div class="footer-nav-links d-flex flex-wrap ps-lg-5 justify-content-center justify-content-md-left">
							...
							<div class="footer-nav-links__item mt-2 pt-1 pt-md-0 mt-md-0 d-flex flex-column align-items-center col-3 col-md-3">
								...
								<a class="d-block hvr-link-div text-center text-md-left alifot text-white" href="<?php echo site_url(); ?>/ui-ux-design/">
							...
							<div class="footer-nav-links__item mt-2 pt-1 pt-md-0 mt-md-0 d-flex flex-column align-items-center col-3 col-md-3">
								<a class="d-block hvr-link-div text-center text-md-left alifot text-white" href="<?php echo site_url(); ?>/ui-ux-design-agency-in-usa/">
							...
							<div class="footer-nav-links__item mt-2 pt-1 pt-md-0 mt-md-0 d-flex flex-column align-items-center col-3 col-md-3">
								<a class="d-block hvr-link-div text-center text-md-left alifot text-white" href="<?php echo site_url(); ?>/ui-ux-design-agency-in-uae/">
							...
							<div class="footer-nav-links__item mt-2 pt-1 pt-md-0 mt-md-0 d-flex flex-column align-items-center col-3 col-md-3">
								<a class="d-block hvr-link-div text-center text-md-left alifot text-white" href="<?php echo site_url(); ?>/ui-ux-design-agency-vietnam/">
