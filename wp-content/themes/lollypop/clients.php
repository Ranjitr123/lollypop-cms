...
?>
 ...
 <main class="main">
        ...
        <div class="container"> 
          <div class="row"> 
            <div class="col-12 col-md-11 col-lg-10 mx-auto">
              ...
              <!--<div class="nav scroll-hide bg-gray lollypop-tabs color-gray stickytab lollypop-tabs--vertical nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <button class="fnt-26 fnt-800 nav-link active" id="v-pills-brands-tab" data-bs-toggle="pill" data-bs-target="#v-pills-brands" type="button" role="tab" aria-controls="v-pills-brands" aria-selected="true">Top Brands</button>
                <button class="fnt-26 fnt-800 nav-link" id="v-pills-startups-tab" data-bs-toggle="pill" data-bs-target="#v-pills-startups" type="button" role="tab" aria-controls="v-pills-startups" aria-selected="false">Startups</button>
                <button class="fnt-26 fnt-800 nav-link" id="v-pills-ideas-tab" data-bs-toggle="pill" data-bs-target="#v-pills-ideas" type="button" role="tab" aria-controls="v-pills-ideas" aria-selected="false">Ideas</button>
              </div>-->
              ...
              <!--  <div class="tab-pane fade" id="v-pills-startups" role="tabpanel" aria-labelledby="v-pills-startups-tab">
                  <ul class="px-0 logo-list row">
                   <?php if( have_rows('start_logos') ) : while( have_rows('start_logos') ): the_row(); ?>
                    <li class="logo-list__item col-4 col-md-3 data-scroll"><img class="img-fluid grayscale" src="<?php the_sub_field('images'); ?>"></li>
                    <?php wp_reset_postdata(); endwhile; endif; ?>
                  </ul>
                </div>
                <div class="tab-pane fade" id="v-pills-ideas" role="tabpanel" aria-labelledby="v-pills-ideas-tab">
                  <ul class="px-0 logo-list row">
                   <?php if( have_rows('idea_logs') ) : while( have_rows('idea_logs') ): the_row(); ?>
                    <li class="logo-list__item col-4 col-md-3 data-scroll"><img class="img-fluid grayscale" src="<?php the_sub_field('images'); ?>"></li>
                    <?php wp_reset_postdata(); endwhile; endif; ?>
                  </ul>
                </div>-->
      ...
      <!--03-->
      <!--<section class="sec-pd sec-pt sec-pb sec-client" id="third" style="background: #221429;">
        <div class="container"> 
          <div class="row"> 
            <div class="col-112 col-md-11 col-lg-10 mx-auto">
             <div class="col-12 col-md-10 col-lg-7 px-0 offset-md-1">
             <?php if( have_rows('case_studies') ) : while( have_rows('case_studies') ): the_row(); ?>
              <div class="sec-head"> 
                <h2 class="fnt-50 fnt-800 mb-3 clr-white data-scroll"><?php the_sub_field('title'); ?></h2>
                <div class="mb-4 col-md-10 col-lg-9 px-0">
                  <p class="fnt-24 data-scroll clr-white"><?php the_sub_field('content'); ?></p>
                </div>
                <div class="d-flex justify-conttent-between align-items-center flex-wrap">
                  <div class="col-8 px-0"> <a class="clr-second hvr-line d-inline-block data-scroll" href="<?php the_sub_field('url'); ?>">View Project</a></div>
                </div>
              </div>
            ...
            <div class="col-12 col-md-10 col-lg-8 mx-auto">
              <div class="col-12 col-md-10 col-lg-9 px-0 mb-4 pb-3 mb-lg-5 pb-lg-2">
               ...
               <!--<a class="video-img position-relative popup-vimeo popup-youtube d-block" href="<?php the_sub_field('video_url') ?>">
                <div class="reveal"> <img src="<?php the_sub_field('image') ?>"></div>
                <div class="play-icon play-icon--red"><i class="icon-play"></i></div></a>-->
