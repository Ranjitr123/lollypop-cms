...
$(document).ready(function () {
	...
	var sixth = new ScrollMagic.Scene({
		triggerElement: '#sixth',
		duration: $('#sixth').outerHeight()
		// triggerHook: 0.1,
	}).setClassToggle('body', 'color-white').addTo(controller);

	var sixth = new ScrollMagic.Scene({
		triggerElement: '#sixth',
		duration: $('#sixth').outerHeight()
		// triggerHook: 0.1,
	}).setClassToggle('#sixth', 'active').addTo(controller);

	var seventh = new ScrollMagic.Scene({
		triggerElement: '#seventh',
		duration: $('#seventh').outerHeight()
		// triggerHook: 0.1,
	}).setClassToggle('body', 'color-white').addTo(controller);
	...
	var seventh = new ScrollMagic.Scene({
		...
		duration: $('#seventh').outerHeight()
		// triggerHook: 0.1,
	}).setClassToggle('#seventh', 'active').addTo(controller);
});

},{}]},{},[1])//# sourceMappingURL=home-scroll-animation.js.map
