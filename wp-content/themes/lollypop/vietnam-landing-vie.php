...
/**
 * * Template Name: Vietnam Landing vietnam Locations
 * *
 * * @package WordPress
 * */

get_header('vietnam-vie');
                ...
                <div class="col-12 col-md-7">
                  <div class="profile d-flex flex-column">
                    <div class="profile__about">
                      ...
                      <!--<p class="fnt-16 clr-black-354 data-scroll"><?php //the_sub_field('content'); 
                                                                      ?></p>-->
                    </div>
                    <div>
                        ...
                        <div class="srv__info col-12 col-md-8">
                          <div class="row justify-content-between">
                            <div class="col-12 col-md-6">
                              ...
                              <a class="hvr-line clr-second fnt-14 data-scroll tab-sw-hd d-none d-md-inline-block" tab-id="#<?php the_sub_field('title'); ?>" href="<?php the_sub_field('learn_more_url'); ?>">Xem thêm</a>
                            </div>
                            <div class="col-12 col-md-5">
                              ...
                              <a class="hvr-line clr-second fnt-14 data-scroll tab-sw-hd d-md-none" tab-id="#<?php the_sub_field('title'); ?>" href="<?php the_sub_field('learn_more_url'); ?>">Xem thêm</a>
                            </div>
                          </div>
                        </div>
        ...
        <div class="col-md-10 col-lg-8 mx-auto">
          ...
          <ul class="px-0 home-artical-list">
            ...
            if ($whitepaper->have_posts()) : while ($whitepaper->have_posts()) : $whitepaper->the_post(); ?>
                ...
                <a class="clr-second fnt-14 hvr-line data-scroll" href="<?php echo site_url() ?>/whitepapers/">Xem tất cả</a>
          ...
          <ul class="px-0 home-artical-list">
            <?php if (have_rows('blogs')) : while (have_rows('blogs')) : the_row(); ?>
                ...
                <a class="clr-second fnt-14 hvr-line data-scroll" href="<?php echo site_url() ?>/blogs/">Xem tất cả</a>
            <?php endwhile;
            endif; ?>
          </ul>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-center">
              <div class="col-12 col-md-8 col-lg-7 px-0 d-inline-block clr-white text-center">
                <?php if (have_rows('get_in_touch')) : while (have_rows('get_in_touch')) : the_row(); ?>
                    ...
                    </div><a class="web-btn web-btn--red" href="<?php the_sub_field('cta_url'); ?>">Kết nối ngay</a>
                <?php wp_reset_postdata();
                  endwhile;
                endif; ?>
              </div>
