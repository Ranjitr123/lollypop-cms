<?php
/**
 * * Template Name: UAE Arabic Landing Locations
 * *
 * * @package WordPress
 * */
 ...
 <div class="col-md-11 mx-auto width-container">
          <div class="row">
            <div class="col-12 px-md-0">
              <ul class="px-0 lp-awards-list d-flex four-card-slider case-study-slider-<?php echo $count; ?>">
               <?php  $count = 1; if( have_rows('new_case_studies_slider_section') ) : while( have_rows('new_case_studies_slider_section') ): the_row(); ?>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 col-md-8 mx-auto">
            <div class="mb-5">
				<?php if( have_rows('celebrating_years_section__heading') ) : while( have_rows('celebrating_years_section__heading') ): the_row(); ?>
               <h5 class="fnt-40 fnt-800 data-scroll px-0 sec-2" style="opacity: 0.5; transform: translateY(0px);margin-left:auto;"><?php the_sub_field('heading'); ?></h5>
               <p class="fnt-24 sec-2" style="margin-left:auto;"><?php the_sub_field('sub__text'); ?></p>
				<?php endwhile; endif; ?>
			</div>
          </div>
       </div>
