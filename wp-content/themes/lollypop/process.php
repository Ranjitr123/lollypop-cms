          ...
          <div class="row">
            <div class="col-12 col-md-10 offset-md-1">
              ...
              <div class="tab-section1">
                <div class="nav px-0 tab-head-item1 w-100 mb-lg-3 lollypop-tabs justify-content-between color-gray stickytab lollypop-tabs--vertical nav-pills" style="background: #f7f4f2">
                  <?php if (have_rows('tab_content')) : while (have_rows('tab_content')) : the_row(); ?>
                      <div class="fnt-28 fnt-800 nav-link tab-head-item1__name m-0" style="cursor:pointer; flex:auto; align-self: flex-end;">
                        <div class="fnt-16 small-title"><?php the_sub_field('small_title'); ?></div>
                        <div class="fnt-800"><?php the_sub_field('tab_title'); ?></div>
                      </div>
                  <?php endwhile;
                  endif; ?>
                </div>
