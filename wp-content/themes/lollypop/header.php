...
<link rel="shortcut icon" type="image/svg" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/img/Path.svg" alt="Image">
<link rel="shortcut icon" type="image/svg" sizes="18x18" href="<?php echo get_template_directory_uri(); ?>/img/Path.svg" alt="Image">
